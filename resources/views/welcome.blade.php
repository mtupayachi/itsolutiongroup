...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="#">Facturación Electrónica</a>
                  <a class="dropdown-item" href="#">Aplicaciones Móviles</a>
                  <a class="dropdown-item" href="#">Marketing Digital</a>
                  <a class="dropdown-item" href="#">Hosting / Dominio</a>
                  <a class="dropdown-item" href="#">Posicionamiento Seo</a>
                  <a class="dropdown-item" href="#">Servicios ERP</a>
                </div>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" target="_blank">Portafolio</a>
              </li>
              <li class="nav-item">
            ...
            <ul class="navbar-nav nav-flex-icons">
              ...
              <li class="nav-item">
                <a class="btn btn-pink btn-sm mt-3">Learn more</a>
              </li>
            </ul>
      ...
      <!--Carousel DIV DEL SLIDER PRINCIPAL-->
      <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="view" style="background-image: url('img/it/slider.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="carousel-item">
            <div class="view" style="background-image: url('img/it/slider1.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <!--Third slide-->
          <div class="carousel-item">
            <div class="view" style="background-image: url('img/it/slider2.jpg'); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="container">
          ...
          <section class="my-5">
            ...
            <p class="lead grey-text text-center w-responsive mx-auto mb-5">
              Profesionales a su Servicio, tiene Ud. un proyecto en mente? Nosotros somos los indicados para digitalizar sus ideas y proyectos.
            </p>
            <div class="row">
              <div class="col-md-4">
                <!-- Card -->
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                      <a href="#" class="btn btn-primary justify-content-center">Leer Más...</a>
                    </div>
              ...
              <div class="col-md-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <!-- Button -->
                    <div class="d-flex justify-content-center">
                      <a href="#" class="btn btn-success justify-content-center">Leer Más...</a>
                    </div>
              ...
              <div class="col-md-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <!-- Button -->
                    <div class="d-flex justify-content-center">
                      <a href="#" class="btn btn-warning justify-content-center">Leer Más...</a>
                    </div>
          ...
          <section class="my-5">
            ...
            <!-- Section heading -->
            <h2 class="h1-responsive font-weight-bold text-center my-5">Nuestros Servicios</h2>
            <!-- Section description -->
            ...
            <div class="row text-center">
              ...
              <div class="col-md-4 mb-md-0 mb-5">
                ...
                <div class="testimonial">
                  ...
                  <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-left pr-2"></i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod
              ...
              <div class="col-md-4 mb-md-0 mb-5">
                ...
                <div class="testimonial">
                  ...
                  <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-left pr-2"></i>Ut enim ad minima veniam, quis nostrum exercitationem ullam
              ...
              <div class="col-md-4">
                ...
                <div class="testimonial">
                  ...
                  <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-left pr-2"></i>At vero eos et accusamus et iusto odio dignissimos ducimus qui
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                ...
                <a href="#!" class="indigo-text">
                  <h6 class="font-weight-bold mb-3"><i class="fa fa-suitcase pr-2"></i>Travels</h6>
                </a>
                <!-- Post title -->
                <h3 class="font-weight-bold mb-3"><strong>Title of the news</strong></h3>
                <!-- Excerpt -->
